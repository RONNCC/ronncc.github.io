...
(function(){
  ...
  var MUSEUMS = [
    ...
    {key:'sfwa', name:'San Francisco Women Artists Gallery', city:'San Francisco', region:'SF', lat:37.78918, lng:-122.41114, hours:'Tue–Sat 11–5', walker:'yes', icom:'unknown', card:'walker', addr:'640 Sutter St, San Francisco, CA'},
    ...
    {key:'kala', name:'Kala Art Institute', city:'Berkeley', region:'East Bay', lat:37.86810, lng:-122.29560, hours:'Tue–Sun 12–5', walker:'yes', icom:'unknown', card:'walker', addr:'2010 8th St, Berkeley, CA'},
    {key:'dougadams', name:'Doug Adams Gallery', city:'Berkeley', region:'East Bay', lat:37.87390, lng:-122.26930, hours:'Tue–Thu 10–4', walker:'yes', icom:'unknown', card:'walker', addr:'2057 Hearst Ave, Berkeley, CA'},
    {key:'richmondac', name:'Richmond Art Center', city:'Richmond', region:'East Bay', lat:37.93510, lng:-122.34440, hours:'Tue–Sat 10–5', walker:'yes', icom:'unknown', card:'walker', addr:'2540 Macdonald Ave, Richmond, CA'},
    ...
    {key:'paloaltphm', name:'Palo Alto History Museum', city:'Palo Alto', region:'South Bay', lat:37.44360, lng:-122.15740, hours:'Wed–Sun 10–5', walker:'yes', icom:'unknown', card:'walker', addr:'380 Hamilton Ave, Palo Alto, CA'},
    ...
    {key:'sonomava', name:'Sonoma Valley Museum of Art', city:'Sonoma', region:'North', lat:38.29098, lng:-122.45846, hours:'Wed–Sun 11–5', walker:'yes', icom:'unknown', card:'walker', addr:'555 Broadway, Sonoma, CA'},
    ...
    {key:'marinh', name:'Marin History Museum', city:'San Rafael', region:'North', lat:37.97528, lng:-122.52944, hours:'Wed–Sun 12–4', walker:'yes', icom:'unknown', card:'walker', addr:'1102 4th St, San Rafael, CA'},
    ...
    {key:'ucsarb', name:'UC Santa Cruz Arboretum', city:'Santa Cruz', region:'Coast/Santa Cruz', lat:36.98271, lng:-122.06142, hours:'Daily 9–5', walker:'yes', icom:'unknown', card:'walker', addr:'1402 Capen St, Santa Cruz, CA'},
